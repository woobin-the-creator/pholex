...
class LotStatus(Base):
    ...
    process_step: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    hold_comment: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    hold_operator_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True, index=True)
